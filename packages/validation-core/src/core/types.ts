...
export type ValueTransformer<T> =
  | {
      ...
      handler: (value: T | undefined) => Promise<T>;
    }
  | {
      trigger: "afterValidate";
      handler: (
        /** The current value after 'beforeValidate' transformers have run. */
        currentValue: T | undefined,
        validationResult: ValidationResult,
        /** The value as it was at the start of the validation cycle, before any 'beforeValidate' transformers were applied. */
